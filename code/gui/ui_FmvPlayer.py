...
" } ")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/imgFMV/images/screenshot.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_CaptureFrame.setIcon(icon1)
...
"                }")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/imgFMV/images/skip-previous.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/imgFMV/images/fast-rewind.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_rewind.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/imgFMV/images/stop.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/imgFMV/images/play-arrow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/imgFMV/images/fast-forward.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/imgFMV/images/skip-next.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/imgFMV/images/repeat.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_repeat.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/imgFMV/images/volume_up.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/imgFMV/images/grayscale.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionGray.setIcon(icon10)
        ...
        self.actionCapture_Current_Frame.setIcon(icon1)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/imgFMV/images/capture_all_frames.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionExtract_All_Frames.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/imgFMV/images/show-metadata.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShow_Metadata.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/imgFMV/images/video-converter.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionConverter_Video.setIcon(icon13)
        self.actionConverter_Video.setObjectName("actionConverter_Video")
        self.actionSave_Video_Info = QtWidgets.QAction(PlayerWindow)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/imgFMV/images/save-video-info.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave_Video_Info.setIcon(icon14)
        self.actionSave_Video_Info.setObjectName("actionSave_Video_Info")
        self.actionAudio = QtWidgets.QAction(PlayerWindow)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/imgFMV/images/show-bitrate.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAudio.setIcon(icon15)
        self.actionAudio.setObjectName("actionAudio")
        self.actionVideo = QtWidgets.QAction(PlayerWindow)
        self.actionVideo.setIcon(icon15)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/imgFMV/images/save-bitrate.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave_Audio.setIcon(icon16)
        self.actionSave_Audio.setObjectName("actionSave_Audio")
        self.actionSave_Video = QtWidgets.QAction(PlayerWindow)
        self.actionSave_Video.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/imgFMV/images/video-info.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShow_Video_Info.setIcon(icon17)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/imgFMV/images/invert-colors.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionInvert_Color.setIcon(icon18)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/imgFMV/images/mono.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionMono_Filter.setIcon(icon19)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/imgFMV/images/canny.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCanny_edge_detection.setIcon(icon20)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/imgFMV/images/magnifier-glass.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionMagnifying_glass.setIcon(icon21)
        ...
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/imgFMV/images/automatic-contrast.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAuto_Contrast_Filter.setIcon(icon22)
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/imgFMV/images/mosaic.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCreate_Mosaic.setIcon(icon23)
        ...
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/imgFMV/images/rubber-stamp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionStamp.setIcon(icon28)
        ...
        self.actionMeasureDistance.setIcon(icon29)
        ...
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(":/imgFMV/images/ruler_surface.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionMeasureArea.setIcon(icon30)
        ...
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/imgFMV/images/HandDraw.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionHandDraw.setIcon(icon31)
        ...
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/imgFMV/images/mirrored.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionMirroredH.setIcon(icon32)
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/imgFMV/images/censure-pencil.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCensure.setIcon(icon33)
        self.actionCensure.setObjectName("actionCensure")
        self.actionRemove_Last_censured = QtWidgets.QAction(PlayerWindow)
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(":/imgFMV/images/censure-pencil-remove-last.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRemove_Last_censured.setIcon(icon34)
        ...
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(":/imgFMV/images/censure-pencil-remove-all.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRemove_All_censured.setIcon(icon35)
        ...
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-polygon-remove-last.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDraw_Polygon_remove_last.setIcon(icon36)
        ...
        icon37 = QtGui.QIcon()
        icon37.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-polygon-remove-all.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDraw_Polygon_remove_all.setIcon(icon37)
        ...
        icon38 = QtGui.QIcon()
        icon38.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-point-remove-last.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRemove_Last_Pinpoint.setIcon(icon38)
        ...
        icon39 = QtGui.QIcon()
        icon39.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-point-remove-all.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRemove_All_Pinpoint.setIcon(icon39)
        ...
        icon40 = QtGui.QIcon()
        icon40.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-polyline-remove-all.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRemove_All_Line.setIcon(icon40)
        ...
        icon41 = QtGui.QIcon()
        icon41.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-polyline-remove-last-segment.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLast_Segment_Line.setIcon(icon41)
        ...
        icon42 = QtGui.QIcon()
        icon42.addPixmap(QtGui.QPixmap(":/imgFMV/images/draw-polyline-remove-last.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRemove_Last_Line.setIcon(icon42)
        ...
        self.actionCenter_on_Platform.setChecked(True)
        icon43 = QtGui.QIcon()
        icon43.addPixmap(QtGui.QPixmap(":/imgFMV/images/center_platform.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCenter_on_Platform.setIcon(icon43)
        ...
        icon44 = QtGui.QIcon()
        icon44.addPixmap(QtGui.QPixmap(":/imgFMV/images/center_footprint.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCenter_on_Footprint.setIcon(icon44)
        ...
        icon45 = QtGui.QIcon()
        icon45.addPixmap(QtGui.QPixmap(":/imgFMV/images/center_target.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCenter_Target.setIcon(icon45)
        ...
        icon46 = QtGui.QIcon()
        icon46.addPixmap(QtGui.QPixmap(":/imgFMV/images/ndvi.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNDVI.setIcon(icon46)
        self.actionNDVI.setObjectName("actionNDVI")
        self.actionCapture_Georeferenced_Frame = QtWidgets.QAction(PlayerWindow)
        icon47 = QtGui.QIcon()
        icon47.addPixmap(QtGui.QPixmap(":/imgFMV/images/save_geoframe.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCapture_Georeferenced_Frame.setIcon(icon47)
